...
var XpiInstaller = {
	...
	extFullName: 'FoxGame', // The name displayed to the user (don't include the version)
	extShortName: 'foxgame', // The leafname of the JAR file (without the .jar part)
	extVersion: '2.0 Alpha',
	extAuthor: 'Ramiro Aparicio',
	extLocaleNames: ['es-ES', 'en-US', 'pl-PL', 'de-DE', 'fr-FR', 'nl-NL', 'it-IT', 'bs-BA', 'pt-PT', 'tr-TR', 'zh-CN', 'zh-TW', 'ru-RU', 'da-DK', 'sl-SI', 'sv-SE', 'ko-KR', 'ro-RO', 'el', 'hu-HU', 'cs-CZ', 'bg-BG', 'lt-LT'],
	...
	install: function()
	{
		...
		var installType = this.profileInstall ? Install.PROFILE_CHROME | Install.DELAYED_CHROME : Install.DELAYED_CHROME;
